      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./promotion.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
    ...
    <tbody>
      ...
      if(count($result) == 0){
        ...
        foreach($result as $item){
          ...
          <td>'.$item["end_date"].'</td>
          <td>
            <button type="button" class="btn btn-warning"><a href="./updatePromotion.php?id='.$item["promotion_id"].'&update='.true.'">Sửa</a></button>
            <button type="button" class="btn btn-danger"><a href="../app/Controller/promotion.php?id='.$item["promotion_id"].'&delete='.true.'">Xóa</a></button>
          </td>
        </tr>
          ';
        }
